...
if [ -d "/home/ubuntu/dynamo" ] && [ -f "/home/ubuntu/dynamo/README.md" ]; then
    echo "Running inside Docker container with /home/ubuntu/dynamo"
    WORKSPACE_DIR=/home/ubuntu/dynamo
elif [ -d "/workspace" ] && [ -f "/workspace/README.md" ]; then
    echo "Running inside Docker container with /workspace"
    WORKSPACE_DIR=/workspace
else
    echo "ERROR: Could not find Dynamo workspace in /home/ubuntu/dynamo or /workspace"
