...
1. Re-read `/home/keivenc/nvidia/dynamo-utils/.cursorrules`
2. Re-read `/home/keivenc/nvidia/dynamo-utils/CLAUDE.md`
...
**Correct** ✅:
```bash
docker exec -u root <container> bash -c "export WORKSPACE_DIR=/home/ubuntu/dynamo && cd /home/ubuntu/dynamo && pytest -xvs tests/serve/test_vllm.py::test_serve_deployment -k aggregated --basetemp=/tmp/pytest_test"
```

**Incorrect** ❌:
```bash
docker exec -u root <container> bash -c "export WORKSPACE_DIR=/home/ubuntu/dynamo && cd /workspace && pytest ..."
```
