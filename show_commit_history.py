...
class CommitHistoryGenerator:
    ...
    def __init__(self, repo_path: Path, verbose: bool = False):
        ...
        self.cache_file = Path("/home/keivenc/nvidia/dynamo_ci/.commit_history_cache.json")
    ...
    def show_commit_history(self, max_commits: int = 50, html_output: bool = False) -> int:
        ...
        try:
            ...
            if html_output:
                ...
                output_path = Path("/home/keivenc/nvidia/dynamo_ci/logs/commit-history.html")
...
Examples:
  ...
  %(prog)s --repo-path /path/to/dynamo_ci --html
    ...
    parser.add_argument(
        '--repo-path',
        type=Path,
        default=Path('/home/keivenc/nvidia/dynamo_ci'),
        help='Path to the Dynamo repository (default: /home/keivenc/nvidia/dynamo_ci)'
    )
