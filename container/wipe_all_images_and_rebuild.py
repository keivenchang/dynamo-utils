...
Usage:
    ...
    python3 container/wipe_all_images_and_rebuild.py --repo-path ~/dev/dynamo_ci --num-image-sha-to-build 2

    # Build specific commit SHAs
    python3 container/wipe_all_images_and_rebuild.py --repo-path ~/dev/dynamo_ci --commit-sha 90ed9ab0e --commit-sha 34c4882d8

    # Cleanup only, no builds
    python3 container/wipe_all_images_and_rebuild.py --repo-path ~/dev/dynamo_ci --num-image-sha-to-build 0 --prune-builder-cache

    # Dry run (show what would be done)
    python3 container/wipe_all_images_and_rebuild.py --repo-path ~/dev/dynamo_ci --num-image-sha-to-build 2 --dry-run
"""
...
Examples:
  ...
  python3 container/wipe_all_images_and_rebuild.py --repo-path ~/dev/dynamo_ci --num 0 --prune-builder-cache
