...
#   - Workspace at $HOME/dev or /workspace
#
# PYTHONPATH SETUP:
#   For development, Python searches these paths before site-packages:
#   export PYTHONPATH="$HOME/dev/components/*/src:$PYTHONPATH"
#
...
if [ -d "$HOME/dev" ] && [ -f "$HOME/dev/README.md" ]; then
    ...
    if [ "$PYTHON_CLEAN" = true ]; then
        ...
        echo "   Checked: $HOME/dev and /workspace"
