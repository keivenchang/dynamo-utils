...
# docker run --gpus all -it --rm --network host --runtime nvidia --shm-size=10G --ulimit memlock=-1 --ulimit stack=67108864 --ulimit nofile=65536:65536 -e HF_TOKEN -v /home/keivenc/nvidia/dynamo/container/..:/workspace -v /tmp:/tmp -v /mnt/:/mnt -v /home/keivenc/.cache/huggingface:/root/.cache/huggingface -w /workspace --cap-add CAP_SYS_PTRACE --ipc host --privileged dynamo:v0.1.0.dev.22e6c96f-vllm-dev
